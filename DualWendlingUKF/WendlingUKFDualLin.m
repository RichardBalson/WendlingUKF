...
%             [Xexp Yexp] = WNM(X(:,p),dt,Input_var, gain, tcon,C);
            Ct = [0.01 0 0;...
                  ...
                  0 0.01 0;...
                  0 0 0.01;...
                  tcon(1)*sigmoid(ExpX(1,p)) 0 0;...
                  tcon(1)*sigmoid(ExpX(2,p)) 0 0;...
                  0 tcon(2)*sigmoid(ExpX(3,p)) 0;...
                  0 0 tcon(3)*sigmoid(ExpX(4,p))];
            Cf = Ci*Ct;    %             Cf = C*d(ExpX)/dP|P =P(-1);????????????????????
