...
IndexErrD = (MeanCheckTStart+EstStart)*sampling_frequency+1:length(output8);
...
Error_name = strcat(Estimation_type,'\','Error_',simulation_initial_name,'_P_',int2str(Dp+Dk),'PE_','Gauss','_N_',int2str(NoiseIn*1e3),'mV');
