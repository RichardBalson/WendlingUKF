...
function [AV BV GV] = Parameter_choice(SimulationSettings,Max_parameters)
...
if (SimulationSettings.Parameter_index ==1)
% 
...
elseif (SimulationSettings.Parameter_index ==2)
AV =[3.5 4.6 7.7 8.7] ;
...
elseif (SimulationSettings.Parameter_index ==3)
...
elseif (SimulationSettings.Parameter_index ==4)
AV = 5;
BV = 20;
GV = 20;
...
elseif (SimulationSettings.Parameter_index ==5)
 AV = 3 + 4*rand(1);
BV = 40*rand(1);
GV = 40*rand(1);   
    
elseif (SimulationSettings.Parameter_index ==6)
...
elseif (SimulationSettings.Parameter_index ==7)
   AV = SimulationSettings.AV;
   BV = SimulationSettings.BV;
   GV = SimulationSettings.GV;
else
    AV =[5 5 4 3];               %Excitatory gain       %Normal activity A=3.25;
    BV =[20 20 15 10];            %Slow inhibitory gain                   B=22;
    GV =[20 20 15 10];
