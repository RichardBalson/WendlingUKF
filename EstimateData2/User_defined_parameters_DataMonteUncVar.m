...
if filter_simulation
    ...
    lowcutoff = 80;%40; % Specify low cutoff frequency for filter
...
kappa =0; % Variable used to define the relative contribution of the mean on the propogation of states, and adjustment of the variance of the sigma points drawn from the Gaussian distribution
...
Var_par_uncertainty = [1 1e-1 1e-2 1e-3 1e-4]; 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Exc_parameter_uncertainty = 1e-2;
SInh_parameter_uncertainty =6e-2;%6e-2
FInh_parameter_uncertainty =6e-2;%6e-2
...
Base_input_uncertainty = 6e-2;%1e-3; % Inherent parameter uncertainty due to model error
...
Observation_uncertainty = 1e-1;%1e-11e-12; %1 Specify the uncertainty in observations
...
saveStates =1; % Specify whether or not states should be saved
